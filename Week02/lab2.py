...
# Additional Weapon Roll Section
print("--- Rolling for your weapon ---")
...
print(f"You rolled a {weaponRoll}. Your weapon is: {chosen_weapon}")

# Weapon strength message
if weaponRoll <= 2:
